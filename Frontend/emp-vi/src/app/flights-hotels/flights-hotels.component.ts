...
export class FlightsHotelsComponent implements OnInit {
  ...
  search() {
    ...
    this.flightSearchRequest = new FlightSearchRequest(this.sourceControl.value, this.destinationControl.value);
    ...
    this.hotelSearchRequest = new HotelSearchRequest(this.destinationControl.value, "");
